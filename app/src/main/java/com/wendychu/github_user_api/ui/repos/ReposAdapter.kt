...
import com.wendychu.github_user_api.databinding.RowItemRepoBinding
...
class ReposAdapter( private val onItemClick: RepoItemClick) : RecyclerView.Adapter<ReposAdapter.ViewHolder>(){
    ...
    inner class ViewHolder(private val binding: RowItemRepoBinding) :
        ...
        fun bind(item: RepoItemModel, onItemClick: RepoItemClick) = with(binding) {
            ...
            ivUserPic.loadImage(item.ownerAvatar)
